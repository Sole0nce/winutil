            ...
            try {
                ...
                if ($Config) {
                    ...
                    if (-not $allConfs) {
                        ...
                        ) -Title "无内容可导出" -Button "OK" -Icon "Warning" | Out-Null
                        return
                    }
            ...
            try {
                ...
                if ($Config) {
                    try {
                        ...
                        $message = "无法从指定路径或 URL 加载 JSON 文件：$_"
                    ...
                    if (-not $flattenedJson) {
                        Show-WinUtilMessage -Message "所选文件不包含要导入的设置。未进行任何更改。" -Title "空的配置" -Button "OK" -Icon "Warning" | Out-Null
                        return
                    }
